        ...
        <nav class="navbar navbar-inverse navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<%=request.getContextPath()%>/home.jsp"></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="<%=request.getContextPath()%>/home.jsp">Revature</a></li>
                        ...
                        <li><a href="<%=request.getContextPath()%>/registration-form.jsp">Register</a></li>
